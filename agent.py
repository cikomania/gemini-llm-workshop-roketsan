...
agent = create_agent(model=model, tools=tools, system_prompt="""
    ...
    RKT-MIL-STD-001 teknik dokümanıyla ilgili bir soru sorulursa mil_std_rag_tool kullan.
    Genel bilgi veya dokümanla ilgisi olmayan bir soru sorulursa general_question_tool kullan.
